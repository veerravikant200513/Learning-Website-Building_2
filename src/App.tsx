...
const Background = () => (
  <div className="fixed inset-0 -z-10 overflow-hidden bg-[var(--color-background)]">
    <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-amber-600/10 rounded-full blur-[120px] animate-float" />
    <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-orange-600/10 rounded-full blur-[150px] animate-float-delayed" />
    <div className="absolute top-[20%] right-[10%] w-[40%] h-[40%] bg-yellow-600/5 rounded-full blur-[100px] animate-float-slow" />
...
const Philosophy = () => (
  ...
  >
    <motion.div
      ...
      className="mb-12 inline-block p-4 rounded-full bg-amber-500/10 text-amber-400"
    >
      <Compass size={32} />
    </motion.div>
    ...
    <div className="mt-16 flex justify-center">
      <AuroraButton
        ...
        glowClassName="from-orange-500 via-amber-500 to-yellow-500"
      >
            ...
            >
              <div className="flex-1 text-center md:text-left">
                <div className={`glass p-8 rounded-3xl hover:bg-white/10 transition-colors duration-300 cursor-pointer ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                  <span className="text-amber-400 font-mono text-sm mb-2 block">{m.year}</span>
                  <h3 className="text-2xl font-serif mb-4">{m.title}</h3>
                  <p className="text-white/70 leading-relaxed">{m.desc}</p>
                </div>
              </div>
              <div className="relative z-10 w-4 h-4 rounded-full bg-amber-500 shadow-[0_0_15px_rgba(245,158,11,0.5)] hidden md:block" />
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {goals.map((g, i) => (
          ...
          >
            <div className="mb-6 p-4 rounded-2xl bg-white/5 text-amber-400 group-hover:text-amber-300 transition-colors duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                type="text"
                required
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 focus:outline-none focus:border-[#D4AF37]/50 transition-colors"
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                <div className="relative">
                  <select
                    className="appearance-none bg-white/5 border border-white/10 rounded-2xl px-4 py-4 pr-10 focus:outline-none focus:border-[#D4AF37]/50 transition-colors cursor-pointer text-sm"
                    value={countryCode}
                    disabled={status === 'loading'}
                ...
                <input
                  type="tel"
                  required
                  className={`flex-1 bg-white/5 border ${phoneError ? 'border-rose-500/50' : 'border-white/10'} rounded-2xl px-6 py-4 focus:outline-none focus:border-[#D4AF37]/50 transition-colors`}
